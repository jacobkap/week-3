...
var query4 = _.without(nathanGameList, nathanGameList[nathanGameList.length - 1]);
...
var query8 = _.union(jeffGameList, nathanGameList);
query8 = _.difference(query8, query7);
